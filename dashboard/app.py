...
def _cached_clinical_review(_schema_version: str = ""):
    """v26.10.6 — 12-hour cache + disk persistence. The 12-month appt
    pull is the slowest fetch in the app (~30-90s on first load); we
    don't want to repeat it just because Streamlit Cloud put the app
    to sleep between visits."""
    ...
    result = compute_clinical_review(get_client())
    try:
