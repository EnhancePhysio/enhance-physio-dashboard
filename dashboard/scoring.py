...
# Punctuality shares the AUDIT band table (82%-98% across 10 bands). The
# rubric itself is correct — the earlier "binary 0/10" behaviour was caused
# by the extraction layer handing scoring a 0 or 1 per practitioner instead
# of a proper fraction (see dashboard/manual.py punctuality parsing).
PUNCTUALITY_BANDS = AUDIT_BANDS
