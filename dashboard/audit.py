...
def _get_letters(client: ClinikoClient, patient_id: str) -> list[dict[str, Any]]:
    try:
        out = list(client.paginate(f"patients/{patient_id}/letters"))
        _record("letters", out)
        return out
    except Exception as e:
...
def _get_patient_appointments(client: ClinikoClient, patient_id: str) -> list[dict[str, Any]]:
    try:
        out = list(client.paginate(f"patients/{patient_id}/individual_appointments"))
...
def _get_recalls(client: ClinikoClient, patient_id: str) -> list[dict[str, Any]]:
    try:
        out = list(client.paginate(f"patients/{patient_id}/patient_recalls"))
        _record("recalls", out)
        return out
    except Exception as e:
