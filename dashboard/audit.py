...
def audit_patient(client: ClinikoClient,
    ...
    # v22 — Cliniko returns some referrer fields as reference objects rather
    # than strings (e.g. `referral_source: {"id": "123", "type": "Contact",
    # "links": {...}}`). Naked concat blew up with "can only concatenate str
    # (not 'dict') to str" on 258/372 patients. _coerce_ref_field unpacks
    # the name out of dicts and coerces everything else to str.
    referrer_blob = " ".join(
